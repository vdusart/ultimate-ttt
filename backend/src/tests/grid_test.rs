...
mod tests {
    ...
    fn test_load_with_subgrid() {
        ...
        let expected_grid = Grid {
            cells: vec![
                Cell::Circle,
                Cell::SubGrid(subgrid1),
                Cell::SubGrid(subgrid2),
                Cell::Circle,
                Cell::SubGrid(subgrid3),
                Cell::Cross,
                Cell::Cross,
                Cell::SubGrid(subgrid4),
                Cell::Circle,
            ],
        };
    ...
    fn test_export_with_subgrids() {
        ...
        assert_eq!(
            subgrid1.export(),
            "000000000000000000000000100001010000000001001000010000"
        );
